...
modelFileName = 'MOBL_ARMS_41_scaled.osim';          % The path to an input model
orientationsFileName = 'imu_orientations_sensors.sto';   % The path to orientation data for calibration 
sensor_to_opensim_rotations = Vec3(-pi/2, 0, 0);% The rotation of IMU data to the OpenSim world frame 
baseIMUName = 'thorax_imu';                     % The base IMU is the IMU on the base body of the model that dictates the heading (forward) direction of the model.
